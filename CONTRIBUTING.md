...
Welcome to marquee! We value your feedback and contributions to make this project better. If you encounter any bugs or have feature requests, please use [Github issues](https://github.com/selemondev/marquee/issues) issues to submit them.
...
- `feat`: Adding a new snippet or significant functionality to the marquee package.

- `fix`: Addressing bugs or issues in existing marquee package.

- `docs`: Commits related to documentation changes for marquee package.

- `style`: Commits related to code formatting, styling, or theming of marquee package.

- `refactor`: Code changes that enhance the library's structure without introducing new features or fixing bugs.

- `perf`: Commits aimed at improving performance for marquee package.

- `test`: Commits related to testing marquee package.

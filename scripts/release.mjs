...
if (explicit) {
  ...
  execSync("pnpm dlx changelogen@latest", { stdio: "inherit" });
  version = explicit;
} else {
  execSync(`pnpm dlx changelogen@latest --bump --hideAuthorEmail ${bumpFlag}`, {
    stdio: "inherit",
  });
...
execSync(`pnpm dlx changelogen@latest gh release v${version}`, { stdio: "inherit" });

...
export const verticalCodeSnippet = `<Marquee class="h-100" direction="up" :fade="true">
  <div>Content 1</div>
  <div>Content 2</div>
  <div>Content 3</div>
</Marquee>`;

export const customGapAndSpeedSnippet = `<Marquee class="gap-12 [--duration:5s] [--gap:3rem]" innerClassName="gap-[3rem]" :fade="true">
  <div>Content 1</div>
  <div>Content 2</div>
  <div>Content 3</div>
</Marquee>`;
